...
<!--
  Generated by Codeman on 2026-08-05. This file is loaded into context at the
...
- Read only the task-relevant progressive documentation linked from it.
...
| Check environment | `./scripts/check-env` |
